---
layout: default
title: "Dot Development - Migrating to 4.0"
permalink: /v2/dot-migrate-to-4/
doc_version: v2
---
...
The [Dot Upgrade Tool](https://github.com/MultiTechSystems/Dot-AT-Firmware) in the Dot-AT-Firmware repository handles CRC and bootloader stripping automatically for all device types:
...
To prepare an image offline without sending:
```
python tools/dot-upgrade.py prepare MDOT full_image.bin -o upgrade_ready.bin
```

[Multitool](https://pypi.org/project/mtsmultitool) can also be used to append a CRC and transfer the file (mDot and xDot only).
